...
JOB_DATA.JOB_DATA_Title AS JOB_Title,
...
$DBQuery="CREATE ALGORITHM = MERGE VIEW VIEW_ACCESS AS
SELECT
ACCESS_LEVEL.ACCESS_LEVEL_ID AS ACCESS_ID,
ACCESS_LEVEL.ACCESS_LEVEL_Title AS ACCESS_Title,
ACCESS_LEVEL.ACCESS_LEVEL_Clearance AS ACCESS_Level,
ACCESS_LEVEL.AVAILABLE_ID AS ACCESS_Avail
FROM
ACCESS_LEVEL;";

...
(
	AVAILABLE_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
...
(
	ACCESS_LEVEL_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
	ACCESS_LEVEL_Title VARCHAR(32) NOT NULL UNIQUE COLLATE utf8_unicode_ci,
	ACCESS_LEVEL_Clearance TINYINT UNSIGNED NOT NULL,
...
(
	COUNTRY_DATA_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
	COUNTRY_DATA_Title varchar(128) NOT NULL UNIQUE COLLATE utf8_unicode_ci,
...
(
	COUNTRY_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
	COUNTRY_CDate TIMESTAMP NOT NULL DEFAULT NOW(),
	ACCESS_LEVEL_ID BIGINT UNSIGNED NOT NULL,
	COUNTRY_DATA_ID BIGINT UNSIGNED NOT NULL,
	AVAILABLE_ID BIGINT UNSIGNED NOT NULL,
...
(
	COUNTY_DATA_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
...
(
	COUNTY_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
	COUNTY_CDate TIMESTAMP NOT NULL DEFAULT NOW(),
	ACCESS_LEVEL_ID BIGINT UNSIGNED NOT NULL,
	COUNTRY_ID BIGINT UNSIGNED NOT NULL,
	COUNTY_DATA_ID BIGINT UNSIGNED NOT NULL,
	AVAILABLE_ID BIGINT UNSIGNED NOT NULL,
...
(
	COMPANY_DATA_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
	COMPANY_DATA_Title varchar(128) NOT NULL UNIQUE COLLATE utf8_unicode_ci,
...
(
	COMPANY_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
	COMPANY_CDate TIMESTAMP NOT NULL DEFAULT NOW(),
	ACCESS_LEVEL_ID BIGINT UNSIGNED NOT NULL,
	COMPANY_DATA_ID BIGINT UNSIGNED NOT NULL,
...
(
	EMPLOYEE_POSITION_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
	EMPLOYEE_POSITION_Title varchar(128) NOT NULL UNIQUE COLLATE utf8_unicode_ci,
...
(
	EMPLOYEE_DATA_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
	...
	EMPLOYEE_DATA_Name VARCHAR(128) NOT NULL COLLATE utf8_unicode_ci,
	EMPLOYEE_DATA_Surname VARCHAR(128) NOT NULL COLLATE utf8_unicode_ci,
...
(
	EMPLOYEE_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
...
(
	CUSTOMER_DATA_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
	CUSTOMER_DATA_Name VARCHAR(128) NOT NULL COLLATE utf8_unicode_ci,
	CUSTOMER_DATA_Surname VARCHAR(128) NOT NULL COLLATE utf8_unicode_ci,
	...
	CUSTOMER_DATA_Email VARCHAR(128) NULL UNIQUE COLLATE utf8_unicode_ci,
...
if(!$DBConn->HasError())
{
	...
	(
		CUSTOMER_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
		CUSTOMER_DATA_ID BIGINT UNSIGNED NOT NULL,
		AVAILABLE_ID BIGINT UNSIGNED NOT NULL,
		ACCESS_LEVEL_ID BIGINT UNSIGNED NOT NULL,
...
(
	JOB_INCOME_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
...
(
	JOB_OUTCOME_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
...
(
	JOB_DATA_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
	JOB_DATA_Title VARCHAR(128) NOT NULL COLLATE utf8_unicode_ci,
...
(
	JOB_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
	JOB_CDate TIMESTAMP NOT NULL DEFAULT NOW(),
	ACCESS_LEVEL_ID BIGINT UNSIGNED NOT NULL,
	JOB_DATA_ID BIGINT UNSIGNED NOT NULL,
	JOB_INCOME_ID BIGINT UNSIGNED NOT NULL,
	JOB_OUTCOME_ID BIGINT UNSIGNED NOT NULL,
	COMPANY_ID BIGINT UNSIGNED NOT NULL,
	AVAILABLE_ID BIGINT UNSIGNED NOT NULL,
	PRIMARY KEY(JOB_ID),
	FOREIGN KEY(ACCESS_LEVEL_ID) REFERENCES ".$sPrefix."ACCESS_LEVEL(ACCESS_LEVEL_ID),
...
(
	JOB_INCOME_TIME_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
...
(
	JOB_ASSIGMENT_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
...
(
	SHAREHOLDER_ID BIGINT UNSIGNED AUTO_INCREMENT UNIQUE,
